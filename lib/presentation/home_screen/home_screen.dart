import '../home_screen/widgets/listburgerking1_item_widget.dart';
import 'controller/home_controller.dart';
import 'models/listburgerking1_item_model.dart';
import 'package:flutter/material.dart';
import 'package:meats_delivery/core/app_export.dart';
import 'package:meats_delivery/presentation/account_page/account_page.dart';
import 'package:meats_delivery/presentation/home_one_page/home_one_page.dart';
import 'package:meats_delivery/presentation/new_order_one_page/new_order_one_page.dart';
import 'package:meats_delivery/presentation/weekly_insights_tab_container_page/weekly_insights_tab_container_page.dart';
...
import 'package:meats_delivery/widgets/custom_bottom_bar.dart';
...
class HomeScreen extends GetWidget<HomeController> {
                                          ...
                                          child: Obx(
                                            () => ListView.separated(
                                              ...
                                              itemCount: controller
                                                  .homeModelObj
                                                  .value
                                                  .listburgerking1ItemList
                                                  .length,
                                              itemBuilder: (context, index) {
                                                Listburgerking1ItemModel model =
                                                    controller
                                                            .homeModelObj
                                                            .value
                                                            .listburgerking1ItemList[
                                                        index];
                                                return Listburgerking1ItemWidget(
                                                  model,
                                                );
                                              },
                                            ),
                                              ...
                                              child: Row(
                                                children: [
                                                  Text(
                                                    ...
                                                    textAlign: TextAlign.left,
                                                    style: AppStyle
                                                        .txtRobotoRomanSemiBold16Pink900
                                                        .copyWith(
                                                      height: getVerticalSize(
                                                        1.07,
                                                      ),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              ...
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
                              style: AppStyle.txtRobotoBold18Pink900.copyWith(
                                height: getVerticalSize(
                                  0.95,
                                ),
                              ),
  ...
  String getCurrentRoute(BottomBarEnum type) {
    switch (type) {
      ...
      case BottomBarEnum.Liveorders:
        return AppRoutes.newOrderOnePage;
      case BottomBarEnum.Insights:
        return AppRoutes.weeklyInsightsTabContainerPage;
      case BottomBarEnum.Orderhistory:
        return "/";
  ...
  Widget getCurrentPage(String currentRoute) {
    switch (currentRoute) {
      case AppRoutes.homeOnePage:
        return HomeOnePage();
      case AppRoutes.newOrderOnePage:
        return NewOrderOnePage();
      case AppRoutes.weeklyInsightsTabContainerPage:
        return WeeklyInsightsTabContainerPage();
