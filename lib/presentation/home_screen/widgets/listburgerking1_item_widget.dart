...
class Listburgerking1ItemWidget extends StatelessWidget {
  Listburgerking1ItemWidget(this.listburgerking1ItemModelObj);

  Listburgerking1ItemModel listburgerking1ItemModelObj;
